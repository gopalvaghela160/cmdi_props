...
function App() {
  ...
  // demand
  var demand =['Coreldraw Training Institute In Surat', 'Game design training institute in surat','C programming language training institute in katargam','Advance nodejs training institute in surat','game design class in Mota Varachha','codeigniter training course','Graphics design training in katargam','Advance nodejs training institute in surat','game design class in Mota Varachha','codeigniter training course','Graphics design training in katargam','Advance nodejs training institute in surat','game design class in Mota Varachha','codeigniter training course','Graphics design training in katargam' ]
  return (
    <div className="App">
